...
function StockCard({ stock, inPortfolio, quote, expanded, onToggle }) {
  ...
  return (
    <div style={{ borderColor: expanded ? vl.color + "55" : inPortfolio ? "#00ff9d33" : "#1c2333", position: "relative" }}
      className="stat-card">
      {/* Portfolio badge */}
      {inPortfolio && (
      ...
      <div onClick={onToggle} style={{ cursor: "pointer" }}
        onMouseEnter={e => { if (!expanded) e.currentTarget.parentElement.style.background = "#ffffff04"; }}
        ...
        <div style={{ textAlign: "center", color: "#8b949e44", fontSize: 10, marginTop: 8 }}>
          {expanded ? "▲ click to collapse" : "▼ click for full company deep dive"}
        </div>
      </div>
  ...
  return (
    <div>
      ...
      <p style={{ color: "#8b949e33", fontSize: 10, marginTop: 20 }}>
        Scores: P/E · P/B · EV/EBITDA · Click any card for full company deep dive
      </p>
    </div>
  );
}
